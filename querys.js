...
db.topics.find(  
    {
    $and:[ 
    {topic_date: {$gte: ISODate("2020-10-01T17:00:00Z"), $lte: ISODate("2020-10-31T18:00:00Z")}}, {"task.task_date":{$gte: ISODate("2020-10-01T17:00:00Z"), $lte: ISODate("2020-10-31T18:00:00Z")}}]
    }  ).pretty()
...
/*-------------------------------------------------------------------------------------------*/
   ...
   db.mentors.find(
   {
   mentee_list:{$gt:15}},{mentor_name:true,_id:false,mentee_list:true})
